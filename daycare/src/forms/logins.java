...
ResultSet rs;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(286, 179, -1, 108));

        setBounds(400, 200, 511, 270);
...
public void tomenu()
{
        try
        {
            ...
            String sql = "select * from parent where username=? and katasandi=?";
            ...
            MainParent x = new MainParent();
            MainParent.txt_auto.setText(logins.txtUser.getText());
            x.setVisible(true);
            hide();
